...
public class PlanHistoryK {
	...
	public PlanHistoryK(int id, String name, int templateId, int planCommercial, int exploitPeriod, String securitDate,
	...
	public String toString() {
		return "PlanHistoryK [id=" + id + ", name=" + name + ", templateId=" + templateId + ", planCommercial="
